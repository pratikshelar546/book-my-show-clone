...
import { BiSearch, BiMenu, BiShareAlt, BiChevronDown } from "react-icons/bi";
    ...
    <div className="flex items-center w-1/2 gap-3">
      ...
      <div className="w-full flex items-center gap-3 bg-white px-3 py-1 rounded-md">
            ...
            <input
              ...
              placeholder="Search for Movie, Event, Plays,Stream,Sports and Activites"
            />
          </div>
        </div>

        <div className="flex items-center gap-3">
          <span className="text-gray-200 text-base flex items-center cursor-pointer hover:text-gray-400">
