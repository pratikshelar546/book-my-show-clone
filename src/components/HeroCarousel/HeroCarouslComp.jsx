    ...
    <HeroSlider {...settings}>
      {
        images.map((images,index)=>(
          <div className="w-full h-full md:h-80 py-3"  key={index}>
            <img src={`https://image.tmdb.org/t/p/original${images.backdrop_path}`}  target="_blanck" alt="hero banner " className="w-full h-full object-cover"/>
          </div>
        ))
      }
    </HeroSlider>
...
export default HeroCarouslComp;
